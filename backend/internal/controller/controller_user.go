...
func MeLogin(reqInfo *models.UserLoginReqInfo) (*types.User, string, error) {
    ...
    InsertAccountAcitvity(nil, user, types.ActivityActoinLogin, 0)
...
func MeLogout(userInfo *types.User, sessionId string) error {
    ...
    InsertAccountAcitvity(nil, userInfo, types.ActivityActoinLogout, 0)
    return nil
}
...
func MeUpdate(userInfo *types.User, info *models.MeUpdateReqInfo) error {
    ...
    InsertAccountAcitvity(userInfo, currentUser, types.ActivityActionUpdate, currentUser.UpdatedAt)
    return nil
}
...
func MeChangePassword(userInfo *types.User, reqInfo *models.MeChangePasswordReqInfo) error {
    ...
    InsertAccountAcitvity(nil, userInfo, types.ActivityActionChangePassword, userInfo.UpdatedAt)
    return nil
}
...
func UserDelete(id string, operator *types.User) error {
    ...
    if info.Role == types.UserRoleSuperAdmin || (info.Role == types.UserRoleAdmin && operator.Role != types.UserRoleSuperAdmin) {
