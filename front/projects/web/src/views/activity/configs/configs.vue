...
import { QueryActivityConfigInfo } from "./common.ts"
...
const filterInfo = ref<QueryActivityConfigInfo>(new QueryActivityConfigInfo(route.params))
...
<template>
  <div class="d-flex gap-3 flex-wrap">
    ...
    <div style="width: 280px">
      <v-activity-action-select v-model="filterInfo.filter.action" mode="config" show-out-label />
    </div>
  ...
  <v-table
    ...
    <el-table-column :label="t('label.config')" min-width="140" prop="config">
      <template #default="scope">
