...
export function ShowInfoMsg(message: string, title?: string) {
  showMessage("info", message, true)
  // notifyMsg("info", message, title, true)
}

export function ShowSuccessMsg(message: string, title?: string) {
  showMessage("success", message, false)
  // notifyMsg("success", message, title, false)
}

export function ShowWarningMsg(message: string, title?: string) {
  showMessage("warning", message, true)
  // notifyMsg("warning", message, title, true)
}

export function ShowErrMsg(message: string, title?: string) {
