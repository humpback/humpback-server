...
import { QueryActivityTeamInfo } from "./common.ts"
...
const filterInfo = ref<QueryActivityTeamInfo>(new QueryActivityTeamInfo(route.params))
...
<template>
  ...
  <v-table
    ...
    <el-table-column :label="t('label.team')" min-width="140" prop="config">
      <template #default="scope">
