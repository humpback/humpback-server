...
import { QueryActivityRegistryInfo } from "./common.ts"
...
const filterInfo = ref<QueryActivityRegistryInfo>(new QueryActivityRegistryInfo(route.params))
...
<template>
  <div class="d-flex gap-3 flex-wrap">
    ...
    <div style="width: 280px">
      <v-activity-action-select v-model="filterInfo.filter.action" mode="registry" show-out-label />
    </div>
  ...
  <v-table
    ...
    <el-table-column :label="t('label.registry')" min-width="140" prop="config">
      <template #default="scope">
