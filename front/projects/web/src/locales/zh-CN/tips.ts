export default {
  tips: {
    ...
    "changePasswordTips": "密码更改成功后，将重新登录系统。",
    ...
    "alwaysPullTips": "对于常驻服务，当版本更改或迁移时，会重新拉取镜像，对于job服务，每次执行时都会重新创建实例。",
    ...
    "replicatedTips":
      "在复制模式下，机器下线后，服务会迁移到其他可用节点，实例数代表当前服务中部署的实例总数，实例数将根据资源（cpu/内存）情况调度到符合条件的机器上。",
    "invalidCorn": "无效Corn",
